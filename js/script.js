		...
		function attachFormValidator(elements) {
			...
			var regularConstraintsMessages = [
				...
				},
				{
					...
					newMessage: "Este no parece un correo valido (ง︡'-'︠)ง."
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "Aqui van solo numeros"
				},
				{
					type: regula.Constraint.Selected,
					newMessage: "Por favor escoje una opcion."
				}
			];
...
document.getElementById('send-message').addEventListener('click', function() {
    ...
    if(userMessage.trim() !== "") {
        var whatsappUrl = "https://wa.me/573025465479?text=" + encodeURIComponent(userMessage);
